/*
 * Esta programacion corresponde a las mediciones y calculos que se implementarán para obtener 
 * la velocidad del carro por medio las ruedas.
*/
...
void loop()
{
  ...
  if (interruptCounter > 0) { // Corresponde a interrupcion del timer
    ...
    vel_rueda = vel_rueda * 3.6; //tenemos km/h


    Serial.print(vel_rueda);// Esto solo fue para verificar los datos (No incluir)
    Serial.print("  ");
